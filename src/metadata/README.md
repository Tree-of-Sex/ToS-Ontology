 ...
 * [toso.yml](toso.yml)
     * Determines how your purl.obolibrary.org/obo/toso/ redirects will be handled
     ...
     * Paste in the contents of [toso.yml](toso.yml)
 ...
 * [toso.md](toso.md)
     ...
     * Paste in the contents of [toso.md](toso.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
